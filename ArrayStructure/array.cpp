...
public:
    ...
    Array(int _size) { // Parameterized Constructor
        size = _size;
        length = 0;
        A = new int[size];
    }
    ...
    do {
        ...
        switch(ch) {
            case 1: std::cout << "Enter an element and index: ";
                ...
                arr1->Insert(index, x);
                break;
            case 2: std::cout << "Enter an index: ";
                std::cin >> index;
                x = arr1->Delete(index);
                printf("Deleted element is %d\n", x);
                break;
            case 3: std::cout << "Enter an element to linear search: ";
                std::cin >> x;
                index = arr1->LinearSearch(x);
                printf("Element index is %d\n", index);
                break;
            case 4: std::cout << "Enter an element to binary search: ";
                std::cin >> x;
...
Operator overloading can be added.
Generic template can be added.
